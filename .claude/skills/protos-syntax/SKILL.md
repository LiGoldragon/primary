---
name: protos-syntax
description: 'The syntax laws of the Protos proto-language behind the NOTA-family textual surfaces schema, NOTA, and logos: positional records typed by expected type, delimiter roles, glued-dot application, capitalization, the total ban on field names with positional disambiguation of same-typed fields, and generics by kind. Read before writing any example syntax; the Nomos macro definition surface is unsettled and is not exemplified.'
---
