...
The living's words are quoted verbatim. No digest, revision, or id appears except a short flow id. The whole datom stays under 8 KB and is sent to Psyche High as the body of one message: `FLOW_ID=<self> hm-send <Psyche High> '<datom>'`.
