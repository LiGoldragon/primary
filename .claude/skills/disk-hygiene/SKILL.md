---
name: disk-hygiene
description: 'Disk-usage cleanup protocol: measure with df and du off the nix store, reclaim old nix generations and rust target dirs safely, ask the psyche before anything else, then re-measure. Reach for it under disk pressure or as periodic host hygiene.'
---
