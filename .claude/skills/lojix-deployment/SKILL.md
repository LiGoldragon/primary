---
name: lojix-deployment
description: 'How to submit and verify current daemon-based Lojix deploys for CriomOS without falling back to archived lojix-cli instructions. Reach for it before any CriomOS system or home deploy.'
---
