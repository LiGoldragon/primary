...
description: 'How to write the recurring workspace-update report that surveys major changes since the last one — files, intent captures, skill evolution, reports landed/retired, component state. Reach for it when synthesizing workspace direction across a busy period.'
---
