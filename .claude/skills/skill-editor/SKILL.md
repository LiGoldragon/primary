---
name: skill-editor
description: 'How skill files are written, named, located, and scoped without growing noisy, and why skills never reference reports. Reach for it when editing a skill file.'
---
