---
name: session-archive-garbage-collection
description: 'Session garbage collection protocol: use aggregator inventory, bounded evidence, typed archives, verification, and exact agent deletion gates.'
---

# session archive garbage collection
