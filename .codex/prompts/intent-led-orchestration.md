...
Fresh-context startup protocol only. Do not activate this command mid-session.
...
lanes, and synthesizes final returns. All workspace interaction happens in
those workers.
...
Allowed lead inputs: this protocol, psyche chat, and worker final returns.
