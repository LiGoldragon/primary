{
  ...
  inputs = {
    ...
    curriculum-deploy = {
      url = "github:LiGoldragon/curriculum-deploy/7cc3cb53a10ab6ada383ea647c1ac87d1409266d";
      inputs.curriculum.follows = "curriculum";
    };
    curriculum = {
      url = "github:LiGoldragon/Curriculum/a8a0a4b8e755bdfbe816af04c846ab4ff2197d00";
      flake = false;
    };
