{
  ...
  inputs = {
    ...
    curriculum-deploy = {
      url = "github:LiGoldragon/curriculum-deploy/c669b27b464f652edd1c1f812e6b7fd20b941ab7";
      inputs.curriculum.follows = "curriculum";
    };
    curriculum = {
      url = "github:LiGoldragon/Curriculum/fd99d0e56f56f5c49f01b1429dda2a0bca4236fb";
      flake = false;
    };
      ...
      checks = forAllSystems (system:
        let
          ...
          fanOutFixtures = pkgs.runCommand "primary-fan-out-fixtures" {
            ...
            touch "$out"
          '';
          clusterRelayContextFixtures = pkgs.runCommand "primary-clusterrelay-context-fixtures" {
            nativeBuildInputs = [ pkgs.nodejs ];
          } ''
            node ${self}/tools/clusterrelay-context.test.mjs
            touch "$out"
          '';
        in
        {
          ...
          clusterrelay-context-fixtures = clusterRelayContextFixtures;
