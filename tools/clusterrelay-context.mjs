...
const usage = 'usage: clusterrelay-context --source FILE --source-flow-id ID --executor-flow-id ID --executor-session-id ID (--source-id ID | --queue-session-id ID --queue-timestamp TS --queue-content-sha256 HASH --queue-line N) [--model MODEL] [--base-instructions FILE] [--runner-revision REVISION] [--model-witness-rollout FILE --model-witness-thread ID --model-witness-turn ID] [--dry-run]';
