...
import {verifyReceipt,verifyRolloutReceipt,activationPrompt,activationPromptFor,canonicalRole,verifyClaimMarker,nativeUuidFromFdTargets,authorizedFreshFieldLowPower} from './native-seat-launch.mjs';
