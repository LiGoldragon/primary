---
description: A parent has delegated a report or witness, or a named tool or flow will consume one.
...
Use a parent-reserved unique path, or acquire edit coordination before sharing a path.
