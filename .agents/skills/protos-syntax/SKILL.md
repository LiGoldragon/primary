---
name: protos-syntax
description: 'The syntax laws of the Protos proto-language behind schema, NOTA, and logos: positional records typed by expected type, delimiter roles, glued-dot application, capitalization, field-name elision under collision, generics by kind, and the rejected double-angle escape. Read before writing any example syntax.'
---
