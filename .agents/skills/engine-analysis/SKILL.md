...
description: 'How to analyze a daemon or engine''s internals through the planes-and-actors lens. Read when you need to understand how an existing engine works inside.'
---
