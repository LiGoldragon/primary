...
## 2026-08-19 — the proposed behavior line rejected fully; the example was taken too literally

Design session `e06e4c07`, typed (captured 2026-08-19T16:53+02:00),
on the proposed behavior line "The origin of a flow's input and the
destination of its output are unknown to the flow; nothing is
designed that depends on knowing them.":

> this is really bad. rejected fully. you misunderstood my intention
> by taking the example too literally and Im not interested to pursue
