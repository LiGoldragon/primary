...
## 2026-08-17 — the pattern deserves a name and hardcore training

The Designer had proposed the testing line "a witness must exercise
the actual boundary — a self-contained imitation confirms only
itself":

> that's vague and confusing. a very common pattern. it deserves a
> name and some hardcore training to be rooted out as deeply as
> possible. It's the same thing as agents claiming to know something
> they dont; they fill up the gaps with nonsense instead of asking
> questions to actually grasp the vision. Very common pattern. One of
> the aspect of the biggest problem with today's incorrectly-trained
> LLMs, which are trained to chase tunnel-vision benchmarks.

## 2026-08-17 — modify the harness system prompts to reward admitting ignorance

The Designer had proposed "claim a thing works only after its witness
ran fresh and you read the output":
...
## 2026-08-17 — overly-erudite, vague prose is talked-over ignorance

On mining `awareness/realization.md` for skill lines:

> probably mostly vague nonsense. If it sounds overly-erudite and
> vague-elitiste, its almost certainly talked-over ignorance.

Context (agent-authored, separate from the psyche's words): the
pattern is one thing seen three ways — a fake witness that confirms
itself, a claim of understanding that papers over a gap, and dense
abstract prose that hides not knowing. Wanted: a name for it, heavy
training against it in the harness system prompts, and every
