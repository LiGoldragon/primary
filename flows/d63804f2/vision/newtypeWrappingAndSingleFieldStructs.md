...
Context (agent-authored, separate from the quote): this question was
asked while reviewing the observer-interface fixture's `Submit.Request`
shape. It is recorded as a question, not as a ruling; the later ruling
below supplies the durable objection.
...
Context (agent-authored, separate from the quote): this ruling rejects
the fixture's double-newtype and single-field-struct shapes; its
`Rejected.{String}` declaration is part of that fixture context.
