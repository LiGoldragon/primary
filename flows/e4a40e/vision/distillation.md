...
The flow had presented five protos statements with one line saying
they land in Vision/protos.md, without the current distilled text or
sources in hand.
...
The flow had asked whether the whole topic is shown again or the
changed blocks with a line saying the rest is unchanged.
