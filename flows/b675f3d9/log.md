...
character, nesting); delimiter table with spoken names ('`:` taken by imports'
withdrawn — parsing is context-dependent, vision/structuralParsing.md); Capability.[…] with 16 named variants — head char carries
