...
## Completed package and Peer transcript witness

The forward correction is Message b472dce4995be45a3b22a253f1366246b47c935e on proposal/cf7879-message-peer-integration. Full remote package build completed: derivation /nix/store/chj18k304kzf0dgklvw84bdf36rj3d1q-message-0.12.0.drv, output /nix/store/ismjm7vhhipzwgyhspr2389sj7yhy9s8-message-0.12.0. Root independently realized this exact derivation with exit 0 and pinned it at /tmp/cf7879-order10-verified-package. Root read the completed build log: 22 test-suite summaries, 65 passed, 0 failed, followed by install and fixup. This supersedes the withdrawn green claims, not the earlier recorded failures.
...
Post-launch checks: remote-control registration is witnessed in sessions/1787967.json, bridgeSessionId session_01AVEAouiVqnHB5igBnRp9Ch. This is registration, not a desktop connection witness. The launch note reached efa157 as exact native user record 82a6b176-9ded-47c5-8125-56232781cc7a at 2026-09-16T17:31:10.618Z, through the Datom prompt-relay route. An initial missing message-cluster PATH error was corrected before sending; it wrote no PTY data. Successor f55ec8ce prompt-relay was refused by the idle gate; its delivery remains pending. No bypass attempted.
