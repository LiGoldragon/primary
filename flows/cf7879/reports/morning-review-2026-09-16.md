...
- Slint prototype: the fixture library compiles remotely and all four offline-state tests pass. The explicit GUI build exposed a missing widget import and a generated-code lint conflict; the GUI is now isolated in a leaf fixture crate with its gate running. GUI, Android and live phone connectivity remain unproved.
