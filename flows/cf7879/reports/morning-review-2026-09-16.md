...
Two of the four held user turns have reached successor efa157 with exact transcript/hash receipts. The other two await its idleness. None is retrospectively delivered to predecessor 840e42, whose approval gate remains blocked. Published reports and transport acknowledgements are kept separate from user-turn receipts.
