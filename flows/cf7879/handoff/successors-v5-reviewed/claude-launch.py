#!/usr/bin/env python3
"""Dry-run by default. Actual launch requires efa157's separate launch word."""
import argparse
import hashlib
import json
import os
...
argv = ['claude', '--bg', '--name', 'primary-claude-successor-efa157',
        '--remote-control', 'primary-claude-successor-efa157', '--model', 'fable',
