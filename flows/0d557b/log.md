...
- Contact-loss reconstruction around the last push landed (reports/contactLossReconstruction.md, addendum in contactLoss.md) and partner payload 2 written; both pushed in 431bb18. Waiting on the living: the permission mode, Codex's answers, and the three questions in payload 1.
