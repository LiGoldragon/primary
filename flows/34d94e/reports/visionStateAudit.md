...
6. Message placement is settled. Busy input should queue is recorded direction; current active-turn merging is an implementation mismatch to resolve, not a reason to ask the living the same question again.
