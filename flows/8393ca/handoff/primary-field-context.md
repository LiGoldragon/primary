# Primary Field source context

Assembled mechanically from the selected paths in context-manifest.md. Each block retains its source path.

## Source: flows/8393ca/vision/operational-herdrVoiceAccess.md

# Operational: a new flow in Herder that the desktop app can reach with interactive voice control
...
## Source: flows/108ab0/vision/operational-programmaticPromptComposition.md

# Operational: compose flow prompts programmatically from typed skills
...
## Source: flows/108ab0/vision/operational-promptMosaicComposition.md

# Operational: the successor's prompt is an amazing mosaic
...
## Source: flows/01a03f49/reports/codexPhoneRemoteControl.md
