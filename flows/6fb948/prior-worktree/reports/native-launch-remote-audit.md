...
| live Flow Nexus | `/home/li/primary/flow/crates/flow-nexus/` and `/home/li/.local/bin/flow-nexus` | Starts/resumes Codex through `codex app-server proxy`; ordinary and meta sockets exist | Flow component |
