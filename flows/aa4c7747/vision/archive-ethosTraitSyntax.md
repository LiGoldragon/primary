Archived on landing: distilled into Vision/ethos.md (Declaration, Kinds), flow e996e8, 2026-09-04. The content is carried there; the words are kept here.
...
(On the flow's interactions-section syntax fork; this scopes the entry above.)
...
(On the flow's fork: (a) trait signatures only vs (b) signatures plus which type carries which interaction, bodies hand-written either way.)
