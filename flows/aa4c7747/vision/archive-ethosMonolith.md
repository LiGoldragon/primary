Archived on landing: distilled into Vision/ethosMonolith.md, flow e996e8, 2026-09-04. The content is carried there; the words are kept here.

# ethosMonolith

## 2026-08-24 — whatever shape it is taking will do; a nexus after it becomes usable
...
## 2026-08-24 — go straight for a nexus; it has to be written as a nexus

(Later in the same conversation as the entry above titled "whatever shape it is taking will do"; this supersedes it.)
...
## 2026-08-24 — ethos-monolith bootstraps ethos-zero; call it ethos-cc?; ethos-zero is version zero for the nexus trinity stack
