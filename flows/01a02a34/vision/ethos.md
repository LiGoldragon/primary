...
Context (agent-authored, separate from the psyche's words): Ethos is the schema
language in the schema/data division under discussion.
...
Context (agent-authored, separate from the psyche's words): Ethos is preferred
over legacy Schema for this epic only if the present Ethos machinery is ready;
readiness remains to be witnessed.
