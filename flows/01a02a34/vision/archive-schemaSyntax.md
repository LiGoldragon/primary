...
Context (agent-authored, separate from the psyche's words): Schema syntax is
both the agent-training surface for using tools and the inspection surface that
exposes weaknesses in the underlying design.
