...
## 2026-08-22T17:32:33.328Z — And you're saying dotos, but like that's the old syntax, which is being replaced by datum, which is, you know, has the same concept.

Context (agent-authored, separate from the psyche's words): Dotos is the old
syntax; Datum is the forward replacement and carries the same underlying
concept.
