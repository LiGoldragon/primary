...
Context (agent-authored, flow fe34eb, 2026-09-10, landing): this
record is archived as distilled into Vision/nexus.md, and its "Nexus
part ... the execution engine inside a Nexus" is superseded. The
living ruled the nexus-core runtime concept overthinking: signal gives
a Nexus its main types and sema its database types; there is no Nexus
root and no separate execution-engine part. See flows/fe34eb/vision/
nexus.md and flows/fe34eb/vision/ethos.md.
