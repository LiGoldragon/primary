...
- Native main-flow receipt: the living typed `/main-flow` in this pane after the first turn. The harness expanded the skill into this seat's context from `/home/li/primary/.claude/skills/main-flow` (command-name `/main-flow`). The gate named above is closed.
