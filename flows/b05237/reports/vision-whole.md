...
The theory half of the picture: what this week's vision says the system is, in candidate operational wording, with the records each statement condenses and the skill it would become. Where things stand, what is ready, and the questions live in the situation report, linked above. Every candidate wording is mine, not the living's; the records named under each are the living's words.
