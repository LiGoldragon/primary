...
Design session `5c8be3ca`, typed, on the draft protocol's line "Every
artifact opens with Origin: flow <short-id> [· subflow <id>] · <date> in
plain markdown":
...
Design session `5c8be3ca`, typed, on the draft protocol's `handoff.md`:
