...
## fb1008c0-2 — 2026-08-14 — lines that guard imagined failures

> you really think an agent would stop and say "I dont have an
> allowed-topic list so I cant proceed"?

> I want a line to avoid this kind of nonsensical proposal for
> skills

— psyche, 2026-08-14T14:31+02:00 (Designer session fb1008c0),
typed, after the Designer defended, then cut, a
distillation-draft line ("There is no allowed-topics list. Flows
log freely; distillation corrects.") that guarded a failure no
agent untold would commit and existed only to record a closed
fork. A line for the skill-designing skill is directed; exact
wording under psyche review.

## fb1008c0-4 — 2026-08-14 — the cut-test line approved

> this is good

— psyche, 2026-08-14T14:53+02:00 (Designer session fb1008c0),
typed, approving the exact wording "A line the agent would obey
without ever having read it" for the skill-designing Cut list,
directed by fb1008c0-2 above. An earlier justification tail
("that is history, and history lives in the psyche log") was
...
## 2026-08-19 — a line repeated across two skills is not good; skill-designing must say so; batch skill edits rather than churn an agent for one line

Design session `e06e4c07`, typed (captured 2026-08-19T16:53+02:00).
The liability line had landed both in vocabulary ("A flow is liable
for its subflows.") and, in full, in the subflows skill:

> youre repeating the liability line. not good. now we need to edit
> the skill-design skill to fix that.

> the subflows edit is good, but lets get the others green before
> editing to avoid churning an agent for a single line
...
## 2026-08-19T21:13:46.391+02:00 — skill editing requires explicit approval after the proposal

Context (agent-authored, separate from the psyche's words): Approval boundary
for the requested proposal to teach root deployment in the authored Lojix
skill. The canonical source is response item line 2328 in
...
## 2026-08-22 — nexus and the software-design skill: dont worry about overlap, they'll probably merge

Design session `15b67974`, typed (captured 2026-08-22T13:39+02:00),
on the flow's concern that a map-doctrine line in nexus would repeat
what the ordered software-design skill will hold:
