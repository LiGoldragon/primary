...
## 2026-08-19 — the component is a Nexus; mandatory traits' first pass made placeholder traits; ontology designed before implementation; Ethos for the main traits and types

Design session `e06e4c07`, dictated (captured 2026-08-19T13:49+02:00).
The full statement is logged under nexus; the lines bearing on this
topic:
...
Context (agent-authored, separate from the psyche's words): "rest
components" reads Rust components; "ESOS" reads Ethos. The
rust-component-architecture skill is to be clarified or rectified to
agree with the Nexus statement.
