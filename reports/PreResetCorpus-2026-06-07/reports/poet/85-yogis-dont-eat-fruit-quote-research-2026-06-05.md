...
## Third pass: both follow-ups done, plus a citation-error correction

- **GRETIL cross-numbering — done.** A verse-anchor table for the Sū. 27 fruit catalogue (and the confirmable vegetables) is folded into `caraka-samhita/fruit-vegetable-warnings.md`, with GRETIL numbers and Sanskrit incipits.
- **Atharvaveda barley hymn — done.** AV 6.142 (Whitney) is extracted into a new `source-extracts/Atharva_Veda/barley-and-grain.md` and cross-referenced from the Ṛgveda *ghṛta* extract — a Vedic grain-primacy witness (the Veda magnifies barley as *unexhausted, like the ocean*, and gives no fruit the like). Verified via Wikisource after the on-disk Whitney's earlier sacred-texts fetch was blocked.
- **Citation-error correction (the cross-numbering's real payoff).** Anchoring the fruits against GRETIL revealed that `Fruit_as_Medicine`'s per-fruit verse numbers were wrong — grapes cited "27.143", mango "27.146", *āmalaka* "27.156", pomegranate "27.157", six-fruits "27.158", *bibhītaka* "27.158b". GRETIL — and the project's own Sharma-2014 markdown, where grapes is the *first* fruit — place grapes at 27.125–126, mango 27.139, six-fruits 27.145–146, *āmalaka* 27.147, *bibhītaka* 27.148, pomegranate 27.149–150. All six are corrected. My earlier philology-note framing — "Sharma 2014 numbering diverges from GRETIL by a non-constant offset" — was itself wrong: Sharma and GRETIL agree on the fruit order and structure; the digest had simply mis-assigned the numbers. The note (`sutrasthana-27-fruit-verses-gretil.md`) is rewritten to say so, and `translation-sources.md` is corrected to match.
