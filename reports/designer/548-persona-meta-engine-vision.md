...
- **spirit** — the cognitive apex and the runnable substrate exemplar; spawned LAST. Captures psyche intent into `spirit.redb` through the full three-plane reaction round-trip; configures mind via `meta-signal-mind`.
