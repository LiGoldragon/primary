...
- `/home/li/primary/reports/second-designer/79-gap-audit-criomos-network.md`
  §"Findings table" rows 1 (wireguard.nix bug), 2 (wifi-eap.nix
  ssid literal), 25 (source-constraints widening).
- `/home/li/primary/reports/second-designer/80-gap-audit-criomos-metal-hardware.md`
  §"Finding 1 — thermal-guard regression on `metal/default.nix`"
  (the full diff and the "verbatim from main" prescription).
- `/home/li/primary/reports/second-designer/81-gap-audit-criomos-services-orchestration.md`
