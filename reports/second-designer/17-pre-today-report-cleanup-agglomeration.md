...
- `reports/designer/116-124` - current component development plans and
  synthesis.
- `reports/second-designer/15-architecture-implementation-drift-audit.md`
  - current implementation drift audit.
- `reports/second-designer/16-new-designer-documents-analysis.md` -
...
`reports/second-designer/15` and `reports/designer/124`: adjacent
...
- `ConnectionClass` is now needed across multiple domains. The old
  ...
  has fired. See `reports/second-designer/16`.
...
- `reports/second-designer/16` calls out redb writer ownership gaps in
  the May 11 plans.
- `reports/second-designer/15` and `reports/designer/124` preserve the
...
`reports/second-designer/16`: preserve `OtherPersona` provenance,
...
- Current implementation drift -> `reports/second-designer/15`.
...
reports/second-designer/1-role-split-bootstrap.md
reports/second-designer/10-abduco-terminal-survivability-research.md
reports/second-designer/11-durable-pty-session-tools-research.md
reports/second-designer/3-ractor-only-actor-architecture-recheck.md
reports/second-designer/4-kameo-ractor-no-zst-switch-assessment.md
reports/second-designer/5-kameo-testing-assistant-findings.md
reports/second-designer/6-public-handle-case-for-kameo.md
reports/second-designer/7-contract-relation-naming-survey.md
reports/second-designer/8-designer-recent-work-and-kameo-testing-audit.md
reports/second-designer/9-persona-mind-implementation-pins-prepass.md
