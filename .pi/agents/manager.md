...
skills: 'intent-clarification, context-handover, helper-context-transfer'
---
...
- Never write field names in positional Protos records.
- Keep delimiter roles and dotted application distinct.
- Do not invent syntax for unsettled surfaces.
...
- `generalist` — Owns coupled delivery.
- `intent-recorder` — Submits approved intent.
- `intent-translator` — Routes clarified work.
- `scout` — Returns witnessed facts.
- `repo-scaffolder` — Builds repository structure.
