...
Eval id: `mind-domain-accepted-knowledge-20260706`
Mode: `isolated-categories`
Model/provider: `deepseek` / `deepseek-v4-flash`
Run status: `passed` (success=true) reasons=[]
Primary cases: 2
Scored rows: 2
Blocked rows: 0
Raw rows: 4
...
Exact prefilter hits / semantic judge attempts: 2 / 0
Judge contract calls / parsed completed responses / format failures / diagnostic messages: 0 / 0 / 0 / 0
...
- `exact_duplicate`: 2/2 passed (100.00%)
