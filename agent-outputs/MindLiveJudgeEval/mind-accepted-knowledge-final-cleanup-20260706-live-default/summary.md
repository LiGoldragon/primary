...
Eval id: `mind-accepted-knowledge-final-cleanup-20260706-live-default`
Mode: `stateful`
...
Submit calls, including rejection store probes: 224
Exact prefilter hits / semantic judge attempts: 28 / 196
Judge contract calls / parsed completed responses / format failures / diagnostic messages: 196 / 196 / 0 / 41
...
- `source_needed_05` `source_needed` diagnosis=ModelVerdictFailure expected {"expected_subject":null,"reasons":["SourceRequired","FalseOrUnsupported"],"target_alias":null,"target_aliases":[],"verdict":"Rejected"} got {"kind":"Rejected","latency_ms":1100,"reason":"NeedsMoreSpecificShape"} notes=["expected reason in [\"SourceRequired\", \"FalseOrUnsupported\"], got NeedsMoreSpecificShape"]
- `contrast_valid_then_duplicate_02` `contrast_set` diagnosis=WrongIdentity expected {"expected_subject":null,"reasons":["SemanticDuplicate"],"target_alias":"K_CONTRAST_PACKET_AFTER_EXACT","target_aliases":["K_CONTRAST_PACKET_AFTER_EXACT"],"verdict":"Rejected"} got {"identity":"4g9a","kind":"Accepted","latency_ms":1234} notes=["expected rejection but got non-rejection reply","expected identity-bearing rejection payload"]
